...
export const useCustomersData = (filters = {}, options = {}) => {
  ...
  // Allow consumer to override scope: 'business' | 'branch'
  const scopeOverride = filters?.scope;
  const isBusinessView = scopeOverride ? (scopeOverride === 'business') : !currentBranch;
  const queryKey = isBusinessView 
